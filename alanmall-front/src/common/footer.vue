  ...
  <footer>
    ...
    <div id="footer">
      <div class="footer-contert">
        <div class="footer-content-logo"><img src="/static/images/header-logo.png" alt="底部LOGO"> <span>缤纷世界，理性购物，享受生活，热爱自己</span>
        </div>
        <div class="footer-content-aboutUs">
          <ul>
            <li>关于我们</li>
            <li><a href="http://www.gupaoedu.com/about.html?con=xueyjianjie">Alan简介</a></li>
        ...
        <div class="footer-content-service">
          <ul>
            <li>服务与支持</li>
            <li><a href="http://www.gupaoedu.com/partner.html?20190422">开发招募</a></li>
        ...
        <div class="footer-content-img">
          <div class="footer-content-img-wx"><span><img src="/static/images/footwechat.png"
      ...
      <div class="footer-copy"> 亮仔Alan属于个人门户目前处于测试阶段，最新体验版将于2020年10月发布，此站源码在github上开源，如发现Bug邮件到yangl546493589@gmail.com，在此表示感谢</div>
    </div>
  </footer>
</template>
<script>
