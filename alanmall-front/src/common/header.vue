        ...
        <div class="w-box">
          <div class="nav-logo">
            <h1 @click="changePage(-1)">
              <router-link to="/" title="每日推荐">每日推荐</router-link>
            </h1>
          </div>
          <div _ngcontent-c1="" class="container">
            <ul _ngcontent-c1="" class="nav-list"> <!---->
            <li _ngcontent-c1=""><a _ngcontent-c1="" class="active" title="每日精选" href="/" target="">每日精选 </a></li>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      delGoods (productId) {
        if (this.login) { // 登陆了
          cartDel({userId: getStore('user_id'), productId}).then(res => {
...
<style lang="scss" rel="stylesheet/scss" scoped>
  ...
  .w-box {
    ...
    h1 {
      ...
      align-items: center;
      > a {
        background: url(/static/images/alanlogo3.png) no-repeat 100%;
