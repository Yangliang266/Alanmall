 ...
 * @author luxf
 */
public class StoreWarehouseInHistoryAction extends InterfaceBaseAction {
	...
	private List<StoreWarehouseOutVo> getPage(StoreWarehouseOutDto storeWarehouseOutDto){
		List<StoreWarehouseOut> swiList = storeWarehouseOutManager.getPageInHistory(storeWarehouseOutDto);
	 ...
	 *  历史记录页面显示
	 */
	public String getStoreWarehouseInHistoryList() {
		...
		Integer t = storeWarehouseOutManager.getPageInHistoryTotal(storeWarehouseOutDto);
		pageData.setTotal(t);
	 ...
	 *  导出历史记录数据
	 */
	public void getStoreWarehouseInHistoryListEexport(){
	 ...
	 *  预览历史记录PDF（可下载，可保存）
	 */
	public void getStoreWarehouseInHistoryHistoryPDFPreview(){
		...
		try {
			...
			// 每列宽度
			float[] columnsWidth = {30f, 30f, 30f, 17f, 17f, 30f, 25f, 30f, 40f};
